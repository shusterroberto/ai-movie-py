...
__all__ = [
    'SpeechGrammarTagWildcard', 'SREAudioLevel',
    'eLEXTYPE_LETTERTOSOUND', 'ISpeechPhraseReplacement',
    'DISPID_SpeechVoice', 'ISpRecoContext2', 'SpeechStreamFileMode',
    'SPRECOGNIZERSTATUS', 'SDTAudio', 'SASPause',
    'SPINTERFERENCE_TOOQUIET', 'SECFIgnoreKanaType',
    'DISPID_SGRsFindRule', 'SGSExclusive', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechRecoResult2', 'SPSSuppressWord', 'SPGS_ENABLED',
    'SpeechRegistryLocalMachineRoot', 'SVSFVoiceMask',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPANumberOfElementsInResult',
    'SpeechPropertyComplexResponseSpeed', 'SVSFParseMask',
    'SPINTERFERENCE_TOOFAST', 'SAFT32kHz8BitStereo',
    'DISPID_SPEAudioSizeTime', 'IEnumSpObjectTokens', 'SVSFIsNotXML',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGCommit',
    'SpeechCategoryAudioOut', 'eWORDTYPE_ADDED', 'SPAR_Unknown',
    'DISPIDSPTSI_ActiveLength', 'SRAONone', 'SVSFPurgeBeforeSpeak',
    ...
    'SSFMOpenForRead', 'DISPID_SPRsCount', 'DISPID_SRRTStreamTime',
    'DISPID_SRProfile', 'SpeechVoiceCategoryTTSRate',
    'SAFTADPCM_11kHzStereo', 'DISPID_SGRSTType', 'SP_VISEME_5',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVEEnginePrivate',
    'SAFT12kHz16BitMono', 'SITooFast', 'SpMMAudioIn',
    'DISPID_SVEBookmark', 'SVP_8', 'DISPID_SVGetVoices',
    'ISpResourceManager', 'SP_VISEME_11', 'eWORDTYPE_DELETED',
    'SP_VISEME_13', 'DISPID_SPAStartElementInResult', 'SPAO_NONE',
    'SPLO_STATIC', 'ISpeechResourceLoader', 'DISPID_SPPId',
    'SpeechCategoryAudioIn', 'DISPID_SWFEExtraData',
    'DISPID_SASetState', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SABufferInfo', 'DISPID_SGRAddState', 'SVEVoiceChange',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPAPhraseInfo',
    'SPINTERFERENCE_NOISE', 'SAFT16kHz16BitMono',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SGRAttributes',
    'DISPID_SABIEventBias', 'eLEXTYPE_RESERVED4',
    'DISPID_SPEAudioTimeOffset', 'ISpeechXMLRecoResult',
    'DISPID_SRCEEnginePrivate', 'SPPS_RESERVED1',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPFM_NUM_MODES', 'SGSDisabled',
    'DISPID_SRCERecognition', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechVoiceSkipTypeSentence', 'SPVPRIORITY', 'SPCS_DISABLED',
    'SpeechRunState', 'DISPID_SpeechAudio', 'SVF_Stressed',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechPhraseElements',
    'SP_VISEME_2', 'DISPID_SGRsAdd', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCRecognizer', 'DISPID_SPRuleChildren',
    'SECFNoSpecialChars', 'DISPID_SpeechPhraseProperty',
    'SVSFParseSapi', 'SVSFUnusedFlags',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRCreateRecoContext',
    'SAFT24kHz8BitMono', 'DISPID_SGRsItem', 'Speech_Max_Pron_Length',
    'DISPID_SAFGetWaveFormatEx', 'SPCT_SLEEP', 'SAFT12kHz8BitMono',
    'ISpStreamFormatConverter', 'SPLEXICONTYPE', 'SpShortcut',
    'SPEI_SR_AUDIO_LEVEL', 'SAFT8kHz16BitStereo', 'SGPronounciation',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRIsUISupported', 'SpeechTokenKeyAttributes',
    'SPDKL_DefaultLocation', 'SPEVENT', 'DISPID_SFSOpen',
    'DISPID_SOTIsUISupported', 'SRERecognition',
    'eLEXTYPE_VENDORLEXICON', 'IEnumString', 'ISpeechPhraseRules',
    'SPEI_END_INPUT_STREAM', 'DISPID_SOTDisplayUI',
    'SPXRO_Alternates_SML', 'DISPID_SASState', 'SVP_12',
    'SPSInterjection', 'ISpeechPhoneConverter',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSVisemeId',
    'SPFM_OPEN_READONLY', 'DISPID_SpeechLexiconPronunciation',
    'SAFTNonStandardFormat', 'DISPID_SGRSTransitions',
    'DISPID_SRGDictationSetState', 'SAFT24kHz16BitStereo',
    'SINoSignal', 'SREPropertyNumChange', 'SRESoundEnd',
    'DISPID_SVIsUISupported', 'DISPID_SPEAudioStreamOffset',
    'SRSInactive', 'ISpeechPhraseRule', 'SPGRAMMARSTATE',
    'SpeechRecoProfileProperties', 'DISPID_SVGetProfiles',
    'eLEXTYPE_PRIVATE12', 'SPEI_RESERVED2', 'SGLexicalNoSpecialChars',
    'SBONone', 'SFTSREngine', 'SP_VISEME_4',
    'DISPID_SPRuleEngineConfidence', 'SRAORetainAudio',
    'SPRST_NUM_STATES', 'DISPID_SBSRead', 'SPSHORTCUTPAIR',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPFILEMODE',
    'DISPID_SVSInputWordPosition', 'DISPIDSPTSI',
    'ISpeechTextSelectionInformation', 'DISPID_SOTCId', 'SPEVENTENUM',
    'DISPID_SRRRecoContext', 'DISPID_SPEActualConfidence',
    'DISPID_SRCEventInterests', 'DISPID_SRGDictationLoad',
    'Speech_StreamPos_Asap', 'DISPID_SPIAudioSizeBytes', 'ISpAudio',
    'SpeechAudioFormatGUIDText', 'DISPID_SPPParent',
    'DISPID_SDKGetlongValue', 'DISPID_SRCPause',
    'SAFTExtendedAudioFormat', 'SpeechVoiceEvents',
    'DISPID_SGRSTs_NewEnum', 'SPCONTEXTSTATE',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPRuleId',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechLexiconPronunciations',
    'DISPID_SPIElements', 'SVEWordBoundary', 'SVP_17',
    'DISPID_SABIMinNotification', 'SPBO_NONE', 'SPSUnknown',
    'SECLowConfidence', 'SLTUser', 'SPVOICESTATUS',
    'SpeechPartOfSpeech', 'DISPID_SRCEPropertyStringChange',
    'SPCATEGORYTYPE', 'DISPID_SRGCmdSetRuleIdState', 'SREStateChange',
    'eLEXTYPE_APP', 'SpeechVoiceSpeakFlags', 'ISpSerializeState',
    'SPRULE', 'DISPID_SpeechGrammarRule', 'SPPS_RESERVED3',
    'ISpeechRecognizer', 'ISpMMSysAudio', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SLWPronunciations', 'ISpLexicon', 'SGRSTTDictation',
    'DISPID_SRAudioInputStream', 'SAFT11kHz8BitStereo',
    'DISPID_SAEventHandle', 'SWPKnownWordPronounceable',
    'DISPID_SGRAddResource', 'eLEXTYPE_USER', 'SAFT24kHz8BitStereo',
    'ISpeechGrammarRuleState', 'SPWORDTYPE', 'DISPID_SFSClose',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPERetainedStreamOffset',
    'SECFIgnoreWidth', 'SPADAPTATIONRELEVANCE', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGetPropertyNumber', 'SAFT8kHz8BitStereo',
    'SpeechGrammarRuleStateTransitionType', 'SpeechUserTraining',
    'SPAS_CLOSED', 'SPAR_Medium', 'SVP_9', 'SpMMAudioEnum',
    'SpeechEngineConfidence', 'SPPS_RESERVED2', 'SDTAll',
    'DISPID_SLWs_NewEnum', 'DISPID_SOTs_NewEnum', 'SP_VISEME_17',
    'DISPID_SRCEEndStream', 'DISPID_SRCVoicePurgeEvent',
    'SPEI_UNDEFINED', 'DISPID_SLPType', 'SPSNotOverriden',
    'DISPID_SVEViseme', 'SPGS_EXCLUSIVE', '_ISpeechVoiceEvents',
    'SGLexical', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SGRSTTEpsilon',
    'SAFTCCITT_uLaw_22kHzMono', 'SPAUDIOBUFFERINFO', 'SVSFNLPMask',
    'SVP_7', 'SPXRO_SML', 'DISPID_SBSSeek', 'DISPID_SPRFirstElement',
    'DISPID_SRSNumberOfActiveRules', 'SPDKL_LocalMachine',
    'SpWaveFormatEx', 'DISPID_SpeechObjectToken', 'DISPID_SRRAudio',
    'DISPID_SVSInputWordLength', 'SAFT16kHz16BitStereo',
    'eLEXTYPE_PRIVATE14', 'DISPID_SASCurrentSeekPosition',
    'SREPhraseStart', 'DISPID_SRCEPropertyNumberChange',
    'SPWORDPRONUNCIATION', 'SAFT11kHz8BitMono', 'ISpPhraseAlt',
    'DISPID_SPEEngineConfidence', 'SITooLoud', 'ISpeechMMSysAudio',
    'SVEViseme', 'SVP_20', 'DISPID_SRCSetAdaptationData',
    'ISpRecoGrammar2', 'DISPID_SGRSTPropertyId', 'SPEI_RESERVED5',
    'ISpRecoContext', 'DISPID_SOTRemove', 'DISPID_SPPChildren',
    'SREAllEvents', 'SpeechTokenKeyUI', 'DISPID_SRCCreateGrammar',
    'SDKLCurrentUser', 'SpeechVoicePriority', 'DISPID_SBSWrite',
    'SPEI_RESERVED6', 'SPRS_ACTIVE', 'SP_VISEME_21', 'SVPAlert',
    'SPEI_PHRASE_START', 'SAFT16kHz8BitMono', 'SPSMF_SAPI_PROPERTIES',
    'ISpRecoCategory', 'DISPID_SVSpeak', 'SPEI_SOUND_START',
    'SPSHORTCUTTYPE', 'DISPID_SpeechLexiconWords',
    'DISPID_SPIReplacements', 'ISpeechObjectTokenCategory',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SOTsItem', 'SLOStatic', 'LONG_PTR', 'SRSActiveAlways',
    'DISPID_SOTCreateInstance', 'ISpeechLexiconWords',
    'DISPID_SLPLangId', 'eLEXTYPE_PRIVATE9', 'SpeechTokenValueCLSID',
    'SAFTADPCM_8kHzMono', 'SPRST_ACTIVE_ALWAYS', 'SPGS_DISABLED',
    'DISPID_SVResume', 'DISPID_SWFEBitsPerSample',
    'SAFTCCITT_ALaw_44kHzMono', 'SPINTERFERENCE_TOOSLOW', 'SPAS_RUN',
    'DISPID_SDKEnumKeys', 'DISPID_SLWWord', 'ISpeechPhraseProperties',
    'SPSEMANTICERRORINFO', 'SpeechPropertyLowConfidenceThreshold',
    'SPPHRASE', 'SDA_Two_Trailing_Spaces', 'DISPID_SGRSTPropertyName',
    'SRTSMLTimeout', 'SDA_One_Trailing_Space', 'ISpeechObjectToken',
    'DISPID_SpeechMemoryStream', 'DISPID_SPRulesItem',
    'DISPID_SLGetPronunciations', 'DISPID_SLPSymbolic',
    'STCLocalServer', 'DISPID_SRCESoundEnd', 'SITooQuiet',
    'ISpeechPhraseProperty', 'SAFTCCITT_uLaw_11kHzStereo',
    'SDA_No_Trailing_Space', 'ISpRecognizer',
    'SSSPTRelativeToCurrentPosition', 'SVSFNLPSpeakPunc', 'SVP_15',
    'DISPID_SDKEnumValues', 'SPBO_PAUSE', 'DISPID_SVEVoiceChange',
    'ISpeechGrammarRule', 'DISPID_SOTCEnumerateTokens', 'SVPOver',
    'DISPID_SGRSTRule', 'SAFT8kHz8BitMono', 'SPSERIALIZEDPHRASE',
    'SREPropertyStringChange', 'SVEPhoneme',
    'DISPID_SRGSetTextSelection', 'SPCT_COMMAND', 'SGDSActive',
    'STCRemoteServer', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechRetainedAudioOptions', 'SAFT32kHz16BitMono',
    'SP_VISEME_20', 'SPLOADOPTIONS', 'ISpeechLexiconWord',
    'DISPID_SRCEBookmark', 'DISPID_SPERetainedSizeBytes',
    'SSSPTRelativeToEnd', 'DISPID_SPELexicalForm',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVESentenceBoundary',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRs_NewEnum',
    'SAFT32kHz8BitMono', 'SPEI_WORD_BOUNDARY', 'SVSFlagsAsync',
    'ISpeechPhraseElement', 'ISpPhoneticAlphabetSelection',
    'SSTTTextBuffer', 'SpeechBookmarkOptions',
    'DISPID_SOTGetAttribute', 'SGRSTTWildcard',
    'DISPID_SRCEStartStream', 'DISPID_SRRAudioFormat',
    ...
    'DISPID_SPISaveToMemory', 'SPEI_RESERVED1', 'ISpVoice',
    'SPRECOCONTEXTSTATUS', 'SpUnCompressedLexicon',
    'STSF_CommonAppData', 'DISPID_SVVolume', 'SPSERIALIZEDRESULT',
    'eLEXTYPE_PRIVATE16', 'eLEXTYPE_PRIVATE17', 'SP_VISEME_16',
    'SpeechDataKeyLocation', 'ISpeechRecoGrammar', 'DISPID_SRCResume',
    'DISPIDSPTSI_SelectionLength', 'ISpEventSink', 'SPSNoun',
    'SpeechMicTraining', 'SAFT22kHz8BitMono',
    'IInternetSecurityMgrSite', 'ISpeechGrammarRuleStateTransitions',
    'SAFT22kHz16BitMono', 'SpSharedRecoContext', 'SPBO_TIME_UNITS',
    'SPRS_INACTIVE', 'DISPID_SVRate', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPRST_INACTIVE', 'DISPID_SRCVoice', 'DISPID_SAVolume',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpMMAudioOut',
    'SpeechAudioVolume', 'DISPID_SMSAMMHandle', 'SDKLLocalMachine',
    'DISPID_SGRsDynamic', 'SAFTGSM610_22kHzMono', 'SPBINARYGRAMMAR',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPARecoResult', 'ISpeechLexicon', 'SP_VISEME_9',
    'SPEI_MIN_SR', 'tagSPTEXTSELECTIONINFO', 'DISPID_SPRuleParent',
    'DISPID_SGRSRule', 'SAFTDefault', 'SGDSActiveUserDelimited',
    'DISPID_SpeechLexiconWord', 'DISPID_SABufferNotifySize',
    'SDKLDefaultLocation', 'SRSEDone',
    'DISPID_SRCAudioInInterferenceStatus', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_PRIVATE7', 'DISPID_SMSGetData', 'Speech_Default_Weight',
    'SPEI_REQUEST_UI', 'ISpRecognizer2', 'DISPIDSPRG',
    'DISPID_SPPConfidence', 'SINone', 'SAFT48kHz16BitStereo',
    ...
    'SPEI_MIN_TTS', 'SGSEnabled', 'SWTAdded', 'SPXMLRESULTOPTIONS',
    'SpeechRecoEvents', 'DISPID_SVPause', 'DISPID_SVEWord',
    'SpResourceManager', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRStatus', 'SpSharedRecognizer', 'eLEXTYPE_PRIVATE5',
    'DISPID_SDKSetLongValue', 'SP_VISEME_19',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpNullPhoneConverter', 'SPAUDIOSTATE', 'DISPID_SVAudioOutput',
    'SRTEmulated', 'SpeechAudioProperties',
    'ISpeechPhraseInfoBuilder', 'ISpeechMemoryStream',
    'SpeechCategoryRecoProfiles', 'SRTReSent', 'DISPID_SPPsCount',
    'DISPID_SDKDeleteValue', 'DISPID_SVSLastStreamNumberQueued',
    'SVP_3', 'SPCT_DICTATION', 'SpeechCategoryPhoneConverters',
    'DISPID_SPIRule', 'DISPID_SpeechVoiceStatus',
    'SAFT11kHz16BitMono', 'STCAll', 'UINT_PTR',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLGenerationId',
    'DISPID_SLGetWords', 'SRAImport', 'SDTProperty',
    'DISPID_SpeechCustomStream', 'DISPID_SRCBookmark',
    'ISpeechRecoContext', 'SAFTADPCM_11kHzMono', 'DISPID_SRRTimes',
    'SpeechPropertyResourceUsage', 'SPWORDLIST', 'eLEXTYPE_PRIVATE6',
    'SpCompressedLexicon', 'SPPS_Modifier', 'SRARoot',
    'ISpeechRecoResult2', 'DISPID_SPIProperties', 'DISPID_SAFGuid',
    'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SWFEBlockAlign', 'SPLO_DYNAMIC', 'SPPS_RESERVED4',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SBSFormat',
    'SREHypothesis', 'DISPID_SOTSetId', 'SDTReplacement',
    'SDTLexicalForm', 'SPPHRASERULE', 'ISpeechRecognizerStatus',
    'DISPID_SPRuleName', 'SpMemoryStream', 'DISPID_SLPsCount',
    'DISPID_SRRAlternates', 'SVPNormal', 'SRTExtendableParse',
    'DISPID_SpeechLexicon', 'SGDSInactive', 'STSF_FlagCreate',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpShortcut',
    'SpeechTokenKeyFiles', 'DISPID_SPEsItem', 'DISPID_SOTDataKey',
    'SpeechFormatType', 'ISpeechVoiceStatus', 'DISPID_SRAudioInput',
    'SPPS_Function', 'SSTTDictation', 'SASRun', 'SVEBookmark',
    'DISPID_SPPs_NewEnum', 'DISPID_SRGetPropertyString',
    'SPEI_END_SR_STREAM', 'eLEXTYPE_PRIVATE2', 'SSTTWildcard',
    'eLEXTYPE_PRIVATE4', 'DISPID_SGRSAddRuleTransition',
    'SpeechTokenShellFolder', 'DISPID_SpeechLexiconProns',
    'ISpeechPhraseAlternates', 'SVEAudioLevel',
    'DISPID_SRRSpeakAudio', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SVP_19', 'SRAExport', 'DISPID_SpeechRecognizer',
    'DISPID_SRRTLength', 'DISPID_SPRulesCount', 'SVP_13',
    'DISPID_SLWType', 'DISPID_SRRGetXMLResult',
    'DISPID_SPRuleFirstElement', 'SDTPronunciation',
    'DISPID_SRCState', 'ISpeechWaveFormatEx',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGReset', 'ISpObjectWithToken', 'eLEXTYPE_RESERVED10',
    'SPPS_LMA', 'SpeechGrammarTagUnlimitedDictation',
    'SPWT_PRONUNCIATION', 'Speech_StreamPos_RealTime',
    'SWPUnknownWordPronounceable', 'SAFTGSM610_44kHzMono',
    'SPFM_OPEN_READWRITE', 'DISPID_SVSRunningState', 'SPEI_VISEME',
    'DISPID_SOTCSetId', 'DISPID_SASFreeBufferSpace',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRText', 'DISPID_SLWLangId',
    'STSF_AppData', 'SPFM_CREATE',
    ...
    'SVEStartInputStream', 'SAFT24kHz16BitMono', 'SDTAlternates',
    'ISpeechBaseStream', 'DISPID_SLPPartOfSpeech', 'SP_VISEME_8',
    'DISPID_SVSLastBookmark', 'SPAO_RETAIN_AUDIO', 'SREStreamStart',
    'DISPID_SVAudioOutputStream', 'DISPID_SVESentenceBoundary',
    'DISPID_SRSetPropertyString', 'ISpeechPhraseAlternate',
    'SVSFParseAutodetect', 'ISpEventSource', 'DISPID_SWFEChannels',
    'SRAInterpreter', 'SPAS_PAUSE', 'SpeechGrammarState',
    'SPRECOSTATE', 'ISpPhoneticAlphabetConverter', 'SDTDisplayText',
    'DISPID_SOTCDefault', 'DISPID_SpeechAudioStatus',
    'SpeechGrammarTagDictation', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVSPhonemeId', 'STCInprocServer', 'SAFT44kHz16BitMono',
    'SP_VISEME_1', 'SSFMOpenReadWrite',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRRSetTextFeedback', 'SINoise', 'SGRSTTRule',
    'SVSFIsFilename', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechPhraseBuilder', 'ISpeechFileStream',
    'DISPID_SRGRecoContext', 'SpTextSelectionInformation',
    'DISPID_SRRTTickCount', 'SPRULESTATE', 'DISPID_SpeechRecoContext',
    'DISPID_SDKCreateKey', 'DISPID_SPPEngineConfidence',
    'SpObjectToken', 'DISPID_SVSLastBookmarkId', 'SPEI_MAX_SR',
    'DISPID_SLPsItem', 'DISPID_SGRSTsCount', 'ISpeechRecoResult',
    'DISPID_SpeechAudioFormat', 'SSSPTRelativeToStart',
    'SPEI_MAX_TTS', 'SpeechInterference',
    'DISPID_SpeechPhraseAlternates', 'SPGRAMMARWORDTYPE',
    'DISPID_SPEDisplayText', 'tagSPPROPERTYINFO', 'SPEI_SOUND_END',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SASCurrentDevicePosition', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVSLastResult', 'DISPID_SPACommit',
    'SAFTADPCM_8kHzStereo', 'SpeechRegistryUserRoot', 'SVP_0',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPIStartTime',
    'DISPID_SPPBRestorePhraseFromMemory', 'SSFMCreateForWrite',
    'SRSActive', 'SpeechPropertyAdaptationOn', 'SRTAutopause',
    'SPVISEMES', 'DISPID_SRCEFalseRecognition',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SDKGetStringValue',
    'SPWORDPRONOUNCEABLE', 'ISequentialStream', 'DISPID_SRGState',
    'ISpProperties', 'SRERecoOtherContext', 'SpObjectTokenCategory',
    'SpLexicon', 'ISpeechLexiconPronunciation',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPRNumberOfElements',
    'SPPHRASEELEMENT', 'ISpObjectTokenCategory', 'SPSHORTCUTPAIRLIST',
    'SRATopLevel', 'eLEXTYPE_PRIVATE19', 'SVSFPersistXML',
    'SpeechStreamSeekPositionType', 'SP_VISEME_3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', '_SPAUDIOSTATE',
    'SAFTNoAssignedFormat', 'DISPID_SVSpeakCompleteEvent',
    'eLEXTYPE_RESERVED8', 'SPWAVEFORMATTYPE', 'ISpeechAudioStatus',
    'DISPID_SpeechPhraseRule', 'STCInprocHandler',
    'SAFT44kHz16BitStereo', 'DISPID_SPEs_NewEnum', 'ISpeechAudio',
    'SRCS_Enabled', 'SPDKL_CurrentUser', 'SPBOOKMARKOPTIONS',
    'SRSEIsSpeaking', 'DISPID_SLWsItem',
    'SWPUnknownWordUnpronounceable', 'SPWT_DISPLAY', 'SP_VISEME_18',
    'ISpRecoGrammar', 'SPEI_RECO_STATE_CHANGE', 'SPAUDIOSTATUS',
    'DISPID_SPIGrammarId', 'DISPID_SVPriority',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechLoadOption',
    'SpNotifyTranslator', 'SVSFParseSsml', 'DISPIDSPTSI_ActiveOffset',
    'ISpPhrase', 'SPEI_SR_PRIVATE', 'DISPID_SRCEAdaptation',
    'SVEPrivate', 'SVP_2', 'SPPHRASEREPLACEMENT', 'SRTStandard',
    'ISpNotifyTranslator', 'DISPID_SMSSetData', 'SpAudioFormat',
    'DISPID_SRGIsPronounceable', 'SpCustomStream',
    'SAFT11kHz16BitStereo', 'tagSTATSTG', 'ISpRecognizer3', 'SASStop',
    ...
    'DISPID_SGRsCount', 'SITooSlow', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVSCurrentStreamNumber',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SOTCategory',
    'SPPS_Verb', 'DISPID_SOTId', 'SPINTERFERENCE',
    'SPINTERFERENCE_NONE', 'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE20',
    'ISpObjectToken', 'SPPS_Noncontent', 'SDTRule',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_PRIVATE10', 'SVSFDefault',
    'SREAdaptation', 'SREStreamEnd', 'DISPID_SPEPronunciation',
    'DISPID_SVAlertBoundary', 'SPAR_Low',
    'DISPID_SpeechXMLRecoResult', 'SRADefaultToActive',
    'DISPID_SPCPhoneToId', 'SAFT48kHz16BitMono',
    'SAFT48kHz8BitStereo', 'DISPID_SPRuleConfidence',
    'DISPID_SRState', 'DISPID_SVSpeakStream', 'SRADynamic',
    'DISPID_SRIsShared', 'DISPID_SpeechPhraseElement',
    'ISpeechRecoResultDispatch', 'SpStreamFormatConverter',
    'DISPID_SRGetFormat', 'SECNormalConfidence', 'DISPID_SAFType',
    'SREPrivate', 'DISPID_SGRSTsItem', 'DISPID_SPRs_NewEnum',
    'SPEI_INTERFERENCE', 'DISPID_SpeechRecoResult', 'SP_VISEME_12',
    'SPWORD', 'ISpStream', 'SPAS_STOP', 'DISPID_SLAddPronunciation',
    'DISPID_SLRemovePronunciation',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SBOPause',
    'SECFDefault', 'ISpeechVoice', 'DISPID_SVEPhoneme',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPIEngineId',
    'DISPID_SVEStreamStart', 'SPINTERFERENCE_TOOLOUD',
    'SDKLCurrentConfig', 'DISPID_SABIBufferSize', 'SRESoundStart',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SLPs_NewEnum',
    'DISPID_SOTCGetDataKey', 'SVEEndInputStream', 'SASClosed',
    'SPPS_Noun', 'SpeechGrammarWordType', 'SGDisplay',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechAudioBufferInfo', 'SVP_14',
    'DISPID_SRCERequestUI', 'SPCS_ENABLED', 'DISPID_SRGetRecognizers',
    'SPVPRI_OVER', 'DISPID_SGRSTNextState', 'DISPID_SGRsCommit',
    'SVSFIsXML', 'SPSModifier', 'SAFT22kHz8BitStereo',
    ...
    'DISPIDSPTSI_SelectionOffset', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SGRName', 'SPWF_SRENGINE', 'SpPhraseInfoBuilder',
    'WAVEFORMATEX', 'SAFTADPCM_44kHzMono', 'DISPID_SVEventInterests',
    'DISPID_SpeechBaseStream', 'DISPID_SRRTOffsetFromStart',
    'SECFIgnoreCase', 'DISPID_SAStatus', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE1', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPPNumberOfElements', 'SPEI_START_SR_STREAM',
    'SpeechAllElements', 'DISPID_SPPName', 'DISPID_SPAsItem',
    'SRCS_Disabled', 'Speech_Max_Word_Length',
    'DISPID_SRCRetainedAudio', 'SVP_18', 'DISPID_SPCIdToPhone',
    'DISPID_SRRecognizer', 'eLEXTYPE_PRIVATE18', 'SPBO_AHEAD',
    'SpeechCategoryAppLexicons', 'SPEI_ADAPTATION',
    '_ISpeechRecoContextEvents', 'IInternetSecurityManager',
    'ISpeechAudioFormat', 'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE8',
    'ISpXMLRecoResult', 'DISPID_SPIGetText',
    'DISPID_SpeechPhoneConverter', 'DISPID_SREmulateRecognition',
    'SpFileStream', 'SPDKL_CurrentConfig', 'SAFT48kHz8BitMono',
    'DISPID_SPERequiredConfidence', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_RESERVED9', 'DISPID_SVDisplayUI',
    'DISPID_SGRSTPropertyValue', 'DISPID_SOTGetDescription',
    'DISPID_SWFEAvgBytesPerSec', 'SLTApp', 'SPAR_High',
    'DISPID_SPILanguageId', 'SAFT22kHz16BitStereo', 'ISpeechDataKey',
    'ISpeechRecoResultTimes', 'SpeechTokenContext',
    'SPEI_TTS_BOOKMARK', 'SPPARTOFSPEECH',
    'DISPID_SpeechPhraseReplacements', 'SAFT44kHz8BitStereo', 'SVP_5',
    'DISPID_SpeechPhraseRules', 'DISPID_SRGId', 'SPPHRASEPROPERTY',
    'SVP_10', 'SP_VISEME_7', 'SVP_21', 'SpStream',
    'DISPID_SDKDeleteKey', 'SPSMF_UPS', 'DISPID_SDKSetStringValue',
    'SPEI_RESERVED3', 'SGRSTTWord', 'SSFMCreate',
    'SPFM_CREATE_ALWAYS', 'ISpStreamFormat', 'SPVPRI_NORMAL',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRGDictationUnload',
    'SAFT44kHz8BitMono', 'SVP_6', 'SAFTCCITT_uLaw_22kHzStereo',
    ...
    'DISPID_SPPFirstElement', 'SPEI_SR_RETAINEDAUDIO', 'SRERequestUI',
    'DISPID_SRCESoundStart', 'DISPID_SRCEPhraseStart',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SOTGetStorageFileName',
    'ISpNotifySource', 'SPCT_SUB_COMMAND', 'SPEI_RECOGNITION',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPROPERTYINFO',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechPropertyResponseSpeed',
    'DISPID_SPPValue', 'DISPID_SLGetGenerationChange',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechPhraseReplacements', 'IStream',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SVEAudioLevel',
    'SRSInactiveWithPurge', 'DISPID_SRRGetXMLErrorInfo',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SLWsCount',
    'DISPID_SPRsItem', 'SpeechVisemeFeature', 'SPPS_SuppressWord',
    'SP_VISEME_10', 'DISPID_SRRSaveToMemory', 'SVF_None',
    'SpInprocRecognizer', 'DISPID_SGRInitialState', 'SREBookmark',
    'SpPhoneticAlphabetConverter', 'ISpDataKey', 'SP_VISEME_6',
    'SpInProcRecoContext', 'DISPID_SMSADeviceId',
    'DISPID_SDKGetBinaryValue', 'ISpeechObjectTokens',
    'SECFEmulateResult', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechGrammarRuleState', 'SPRST_ACTIVE',
    'DISPID_SRCEInterference', 'ISpeechGrammarRules',
    'SPPS_Interjection', 'SAFT12kHz8BitStereo',
    'SpeechRuleAttributes', 'DISPID_SPIRetainedSizeBytes',
    'ISpRecoResult', 'SVP_11', 'DISPID_SGRSTWeight',
    'STSF_LocalAppData', 'SVP_16', 'DISPID_SPAsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SREFalseRecognition', 'SpeechAudioState', 'SpeechAddRemoveWord',
    '_RemotableHandle', 'SAFT8kHz16BitMono', 'SpeechDiscardType',
    'SpeechRecoContextState', 'SVEAllEvents', 'SFTInput',
    'DISPID_SVGetAudioOutputs', 'SECHighConfidence',
    'SAFTGSM610_8kHzMono', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SLODynamic', 'SPEI_SR_BOOKMARK', 'ISpeechCustomStream',
    ...
    'SpeechDisplayAttributes', 'DISPID_SRSAudioStatus', 'SVP_1',
    ...
    'DISPID_SPEsCount', 'DISPID_SVSInputSentenceLength',
    'ISpGrammarBuilder', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechFileStream', 'DISPID_SRDisplayUI', 'SP_VISEME_0',
    'SREInterference', 'SpeechRuleState', 'DISPID_SVEStreamEnd',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SOTRemoveStorageFileName',
    'SAFTText', 'SpeechLexiconType', 'SpVoice',
    'DISPID_SRRPhraseInfo', 'DISPID_SRSClsidEngine',
    'SGDSActiveWithAutoPause', 'SP_VISEME_14', 'SPWT_LEXICAL',
    'SP_VISEME_15', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCRetainedAudioFormat', 'SpeechAudioFormatType',
    'SPPS_NotOverriden', 'DISPID_SRCRequestedUIType', 'SPVPRI_ALERT',
    'DISPID_SPAs_NewEnum', 'DISPID_SPRules_NewEnum',
    'eLEXTYPE_PRIVATE11', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPSHT_OTHER', 'SPSFunction', 'SPWF_INPUT', 'SPPS_Unknown',
    'SPEI_FALSE_RECOGNITION', 'SPSLMA',
    'DISPID_SVSyncronousSpeakTimeout', 'SWTDeleted', 'DISPID_SVSkip',
    ...
    'SAFTADPCM_44kHzStereo', 'SVP_4', 'eLEXTYPE_RESERVED6',
    'SAFT16kHz8BitStereo', 'SpeechWordPronounceable',
    'SPAUDIOOPTIONS', 'DISPID_SMSALineId', 'SAFTGSM610_11kHzMono',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_PRIVATE15', 'ISpNotifySink',
    'SPEI_VOICE_CHANGE', 'ISpeechPhraseInfo', 'SGRSTTTextBuffer',
    'SpeechVisemeType', 'DISPID_SpeechRecoResultTimes', 'SPSVerb',
    'DISPID_SPCLangId', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRGRules',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SpeechDataKey',
    'DISPID_SRCEAudioLevel'
]

_check_version('1.2.0', 1633527258.482388)
